...
Пояснения к обозначениям (не изменяют состав рецептуры):
— NR SMR-20 — натуральный каучук марки SMR 20 (Standard Malaysian Rubber — стандартный малайзийский каучук);
— SBR-1502 — бутадиен-стирольный каучук марки 1502;
— N220 — марка технического углерода, усиливающего наполнителя;
— TMQ — полимеризованный 2,2,4-триметил-1,2-дигидрохинолин, противостаритель-антиоксидант;
— 6PPD — N-(1,3-диметилбутил)-N′-фенил-п-фенилендиамин, противостаритель и антиозонант;
— TMTD — тетраметилтиурамдисульфид, ускоритель серной вулканизации.

Рассчитай прогнозные значения и ориентировочные диапазоны для четырёх характеристик:
— коэффициент теплопроводности, Вт/(м·К);
— степень набухания в моторном масле после выдержки 1006 ч, %;
— степень набухания в воде после выдержки 1006 ч, %;
— относительная плотность (безразмерная величина).

В заключении воспроизведи рецептуру без изменений, укажи область применимости прогноза, источник и ограничения исходных данных. Предложи минимальные лабораторные испытания для проверки этих характеристик. Не подбирай и не меняй состав; не делай выводов о безопасности, сертификации или готовности шины к промышленному применению.`;
