...
async def download_single_file(
    ...
    output_dir: Annotated[
        Optional[str], Field(description="Directory to save the file")
    ] = None,
    filename: Annotated[
        Optional[str], Field(description="Custom filename (optional)")
    ] = None,
    ...
    return await _download_single_file_internal(
        url, output_dir, filename, timeout, max_size_mb
    )
...
async def download_files(
    ...
    tasks = [
        _download_single_file_internal(url, output_dir, None, timeout, max_size_mb)
        for url in urls
    ]
